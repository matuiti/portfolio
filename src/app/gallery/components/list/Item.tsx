...
export const Item = ({ item, onExpand }: ItemProps) => {
  ...
  return (
    ...
    >
      {/* 左側：テキスト・情報セクション */}
      <div className='lg:w-[45%] p-8 lg:p-12 flex flex-col border-b lg:border-b-0 lg:border-r border-neutral-100 bg-white shrink-0 min-w-0'>
        ...
        <div className='flex-1 min-h-0 relative flex flex-col'>
          ...
          {activeTab === 'description' && (
            <div className='absolute bottom-0 left-0 right-0 h-16 bg-liner-to-t from-white via-white/80 to-transparent pointer-events-none z-10' />
          )}
        </div>
      </div>
