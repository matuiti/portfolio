...
export type SearchSmallProps = React.SVGProps<SVGSVGElement> & VariantProps<typeof iconStyles>;

export const SearchSmall = ({ color, size, className, ...props }: SearchSmallProps) => {
  return (
    <svg
      viewBox="0 0 20 20"
      fill="none"
