  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "基礎",
        description:
          "テスト自体の実務経験は1度で、その経験をするまでテストの必要性にピンときていませんでした。プロジェクト当初はテストプログラムの実装予定はありませんでした。ですが終盤に差し掛かりコードベースが膨らんでくると、複数のJavaScriptコードが互いに干渉することが増えたので、簡単な作業を1つするにも多方向に意識を向けつつになり大変に感じていました。そこでE2Eテスト（Playwright）を導入してみることにしました。結果、それまでとは違い追加要件などが怖くなくなりテストのメリットを感じられた成功体験となりました。",
      },
    ],
  },
  {
